--------------------------------------------------------------------------------
-- Handler/AlchemyEventManager.lua
...
Class( "AlchemyEventManager", {
    _handlers         = nil, -- table - Массив зарегистрированных обработчиков (инстансов EventClassInterface).
    _registeredEvents = nil, -- table - Трекер зарегистрированных событий. Структура: { [eventName] = { callback1, callback2, ... } }.
})
